...
public class TestStudent {
	...
	@Test 
	public void testGetNotaMinimaOrderingSetSortatCresator() throws ExceptieNota {
		int notaMinima=4;
	...
	public void testGetNotaMinimaCardinalityZero() throws ExceptieNota {
		...
		int notaMinima=0;
		int notaMinimaCalculata = student.getNotaMinima();
		assertEquals("Testfara note",notaMinima, notaMinimaCalculata);
	}
	...
	public void testGetNotaMinimaCardinalityUnu() throws ExceptieNota {
		...
		int notaMinimaCalculata = student.getNotaMinima();
		assertEquals("Test cu o singura bota",notaMinima, notaMinimaCalculata);
	}
